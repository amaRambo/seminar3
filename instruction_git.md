...
При этом нужно находиться в той ветке, в которую мы хотим добавить ветку.
    ...
    ## В конфликте оставил вариант вхоядящей ветки(которую мы добавляем, сливаем), еще были вырианты оставить как есть и добавить оба варианта.

Примечание: ветки не удалял, что бы их можно было посмотреть.